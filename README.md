...
В футере Яндекс Карты используются как основной способ открыть карточку студии и
построить маршрут. Google Карты доступны как дополнительная ссылка. API-ключи для
карты не требуются.
